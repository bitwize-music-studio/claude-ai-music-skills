...
**Defaults** were calibrated on output from Suno's previous model generation and have not yet been re-measured on v6 (reported v6 profile: de-essed/smeared sibilance, less top-end harshness on most genres, more artifacts on rock and metal) — re-check the presence and mud settings on a v6 corpus before trusting them:
